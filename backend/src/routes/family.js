...
function rowToFamily(row) {
  ...
  return {
    ...
    settings: {
      ...
      penaltyDescription: 'Vamos melhorar!',
      periodType: 'weekly',
      periodStartDay: 0,
      ...
      notificationsEnabled: {
        taskStarting: true, morningSummary: true, streakReminder: true,
        taskApproved: true, goalMilestone: true, pendingApprovals: true,
        periodEnding: true, streakAtRisk: true,
      },
