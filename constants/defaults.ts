...
export const GOAL_VALUES = [1, 2, 3, 4, 5] as const;
...
export const STREAK_MILESTONES: StreakMilestone[] = [
  { days: 3, bonusGoals: 2, label: '3-day streak' },
  { days: 7, bonusGoals: 5, label: '7-day streak' },
  { days: 14, bonusGoals: 10, label: '14-day streak' },
  { days: 30, bonusGoals: 25, label: '30-day streak' },
];
...
export const TASK_TEMPLATES: TemplateCategory[] = [
  {
    ...
    icon: 'weather-sunny',
    templates: [
      { name: 'Wake up on time', description: 'Get out of bed at the scheduled time', goals: 1, icon: 'alarm', category: 'rest', recurrence: { type: 'daily' }, startTime: '06:30', endTime: '06:45' },
      { name: 'Brush teeth (morning)', description: 'Brush teeth after waking up', goals: 1, icon: 'tooth', category: 'hygiene', recurrence: { type: 'daily' }, startTime: '06:45', endTime: '07:00' },
      { name: 'Get dressed', description: 'Put on clothes for the day', goals: 1, icon: 'tshirt-crew', category: 'hygiene', recurrence: { type: 'daily' }, startTime: '07:00', endTime: '07:15' },
      { name: 'Have breakfast', description: 'Eat a healthy breakfast', goals: 1, icon: 'food-apple', category: 'meals', recurrence: { type: 'daily' }, startTime: '07:15', endTime: '07:45' },
      { name: 'Pack school bag', description: 'Prepare backpack with all needed items', goals: 1, icon: 'bag-personal', category: 'school', recurrence: { type: 'daily' }, startTime: '07:45', endTime: '08:00' },
      { name: 'Go to school', description: 'Leave for school on time', goals: 2, icon: 'bus-school', category: 'school', recurrence: { type: 'specific_days', days: [1, 2, 3, 4, 5] }, startTime: '08:00', endTime: '08:15' },
    ],
  },
  {
    id: 'afternoon',
    ...
    templates: [
      { name: 'Have lunch', description: 'Eat lunch', goals: 1, icon: 'silverware-fork-knife', category: 'meals', recurrence: { type: 'daily' }, startTime: '12:00', endTime: '12:45' },
      { name: 'Rest / Quiet time', description: 'Relax after lunch', goals: 1, icon: 'bed', category: 'rest', recurrence: { type: 'daily' }, startTime: '13:00', endTime: '14:00' },
      { name: 'Extra activity', description: 'English, piano, or other extracurricular activity', goals: 3, icon: 'music', category: 'extracurricular', recurrence: { type: 'specific_days', days: [1, 3] }, startTime: '14:00', endTime: '15:00' },
      { name: 'Study / Homework', description: 'Complete homework and study', goals: 3, icon: 'pencil', category: 'study', recurrence: { type: 'specific_days', days: [1, 2, 3, 4, 5] }, startTime: '15:00', endTime: '16:00' },
      { name: 'Reading time', description: 'Read a book or educational material', goals: 2, icon: 'book-open-variant', category: 'study', recurrence: { type: 'daily' }, startTime: '16:00', endTime: '16:30' },
      { name: 'Soccer class', description: 'Attend soccer class', goals: 3, icon: 'soccer', category: 'exercise', recurrence: { type: 'specific_days', days: [2, 4] }, startTime: '16:30', endTime: '18:00' },
    ],
  },
  {
    id: 'evening',
    ...
    icon: 'weather-night',
    templates: [
      { name: 'Dinner', description: 'Eat dinner with the family', goals: 1, icon: 'silverware-fork-knife', category: 'meals', recurrence: { type: 'daily' }, startTime: '19:00', endTime: '19:30' },
      { name: 'Shower / Bath', description: 'Take a shower or bath', goals: 1, icon: 'shower', category: 'hygiene', recurrence: { type: 'daily' }, startTime: '19:30', endTime: '20:00' },
      { name: 'Brush teeth (evening)', description: 'Brush teeth before bed', goals: 1, icon: 'tooth', category: 'hygiene', recurrence: { type: 'daily' }, startTime: '20:00', endTime: '20:10' },
      { name: 'Prepare for bed', description: 'Get ready for bedtime', goals: 1, icon: 'bed', category: 'rest', recurrence: { type: 'daily' }, startTime: '20:10', endTime: '20:30' },
    ],
  },
  {
    id: 'weekly',
    ...
    icon: 'calendar-week',
    templates: [
      { name: 'Clean room', description: 'Tidy up and organize your room', goals: 3, icon: 'broom', category: 'chores', recurrence: { type: 'specific_days', days: [6] } },
      { name: 'Help with household chores', description: 'Help around the house', goals: 2, icon: 'washing-machine', category: 'chores', recurrence: { type: 'specific_days', days: [0] } },
      { name: 'Organize school materials', description: 'Sort and prepare school supplies', goals: 2, icon: 'book-open-variant', category: 'school', recurrence: { type: 'specific_days', days: [5] } },
    ],
  },
];
